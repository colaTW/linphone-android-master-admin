...
public class PrinterTextParserString implements IPrinterTextParserElement {
    ...
    public PrinterTextParserString(
    ...
    public int length() throws EscPosEncodingException {
        ...
        int coef =
                Arrays.equals(this.textSize, EscPosPrinterCommands.TEXT_SIZE_DOUBLE_WIDTH)
                                || Arrays.equals(this.textSize, EscPosPrinterCommands.TEXT_SIZE_BIG)
                        ? 2
                        : 1;
