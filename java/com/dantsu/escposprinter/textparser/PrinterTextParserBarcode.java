...
public class PrinterTextParserBarcode implements IPrinterTextParserElement {
    ...
    public PrinterTextParserBarcode(
        ...
        if (barcodeAttributes.containsKey(PrinterTextParser.ATTR_BARCODE_HEIGHT)) {
            ...
            if (barCodeAttribute == null) {
                throw new EscPosParserException(
                        "Invalid barcode attribute: " + PrinterTextParser.ATTR_BARCODE_HEIGHT);
            }
            ...
            try {
                ...
                throw new EscPosParserException(
                        "Invalid barcode " + PrinterTextParser.ATTR_BARCODE_HEIGHT + " value");
            }
        }
        ...
        if (barcodeAttributes.containsKey(PrinterTextParser.ATTR_BARCODE_WIDTH)) {
            ...
            if (barCodeAttribute == null) {
                throw new EscPosParserException(
                        "Invalid barcode attribute: " + PrinterTextParser.ATTR_BARCODE_WIDTH);
            }
            ...
            try {
                ...
                throw new EscPosParserException(
                        "Invalid barcode " + PrinterTextParser.ATTR_BARCODE_WIDTH + " value");
            }
        }
        ...
        if (barcodeAttributes.containsKey(PrinterTextParser.ATTR_BARCODE_TEXT_POSITION)) {
            String barCodeAttribute =
                    barcodeAttributes.get(PrinterTextParser.ATTR_BARCODE_TEXT_POSITION);

            if (barCodeAttribute == null) {
                throw new EscPosParserException(
                        "Invalid barcode attribute: "
        ...
        if (barcodeAttributes.containsKey(PrinterTextParser.ATTR_BARCODE_TYPE)) {
            ...
            if (barcodeType == null) {
                throw new EscPosParserException(
                        "Invalid barcode attribute : " + PrinterTextParser.ATTR_BARCODE_TYPE);
            }
        }
